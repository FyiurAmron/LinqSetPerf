...
/// <summary>
    ...
    internal sealed class NewSet<TElement>
    {
        /// <summary>
        ...
        /// </param>
        public NewSet(IEqualityComparer<TElement>? comparer, int initSize = 7 )
        {
            _comparer = comparer ?? EqualityComparer<TElement>.Default;
            _buckets = new int[initSize];
            _slots = new Slot[initSize];
        }
